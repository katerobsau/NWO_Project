...
To analyse a random variable that is a bit friendlier in terms of dependence and standard copulas, it is useful to think about how the duration of the surge event is related to the surge height. Exceedance of the threshold is shown here in blue..
